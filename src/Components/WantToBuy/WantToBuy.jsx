...
const WantToBuy = ({ item }) => {
    ...
    return (
        <div data-aos="zoom-out">
            ...
            <Card
                item={item}
                className={` h-[650px] container mx-auto mt-10  overflow-hidden cursor-pointer border hover:drop-shadow-sm`}
            >
                <Card
                    floated={false}
                    shadow={false}
                ...
                <CardBody className="p-4">
                    ...
                    <div className="flex  justify-between my-5 font-medium">
